...
const Groups = () => {
	...
	useEffect(() => {
		...
		// Fetch animal data
		axios
			.get("http://192.168.100.61:5000/animal")
			.then((response) => {
		...
		// Fetch tree data
		axios
			.get("http://192.168.100.61:5000/tree")
			.then((response) => {
	...
	const handleAddGroup = () => {
		...
		axios
			.post("http://192.168.100.61:5000/group", newGroup)
			.then((response) => {
			...
			[
				...
				},
				{
					...
					onPress: () => {
						axios
							.delete(
								`http://192.168.100.61:5000/group/one/${user.id}/${item.id}`,
							)
							.then((response) => {
