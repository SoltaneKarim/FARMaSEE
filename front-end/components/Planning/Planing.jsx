  ...
  const router=useRouter()
	...
	return (
		<ScrollView style={styles.main}>
          ...
          <TouchableOpacity style={styles.child} onPress={() => handleItemClick("/stock")}>
          ...
          <TouchableOpacity style={styles.child} onPress={() => handleItemClick("Manage your farm")}>
          ...
          <TouchableOpacity style={styles.child} onPress={() => handleItemClick("Manage your workers")}>
            <Text style={styles.text}>Manage your workers</Text>
            <View style={styles.imageContainer}>
              <Image
                style={{
                  resizeMode: "contain",
